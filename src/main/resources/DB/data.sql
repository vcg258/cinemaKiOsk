...
INSERT IGNORE INTO statistics (customer_count, date, day, revenue, schedule_id)
VALUES
-- 상영관 1 (일반석) - 영화1, schedule_id 1~3
(85, DATE(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 10 MINUTE)),
 UPPER(DAYNAME(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 10 MINUTE))), 1275000, 1),
(102, DATE(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 240 MINUTE)),
 UPPER(DAYNAME(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 240 MINUTE))), 1530000, 2),
(78, DATE(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 470 MINUTE)),
 UPPER(DAYNAME(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 470 MINUTE))), 1170000, 3),

-- 상영관 2 (일반석) - 영화2, schedule_id 4~6
(90, DATE(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 10 MINUTE)),
 UPPER(DAYNAME(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 10 MINUTE))), 1350000, 4),
(115, DATE(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 240 MINUTE)),
 UPPER(DAYNAME(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 240 MINUTE))), 1725000, 5),
(88, DATE(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 470 MINUTE)),
 UPPER(DAYNAME(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 470 MINUTE))), 1320000, 6),

-- 상영관 3 (리클라이너) - 영화3, schedule_id 7~9
(60, DATE(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 10 MINUTE)),
 UPPER(DAYNAME(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 10 MINUTE))), 1800000, 7),
(72, DATE(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 240 MINUTE)),
 UPPER(DAYNAME(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 240 MINUTE))), 2160000, 8),
(55, DATE(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 470 MINUTE)),
 UPPER(DAYNAME(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 470 MINUTE))), 1650000, 9),

-- 상영관 4 (리클라이너) - 영화4, schedule_id 10~12
(65, DATE(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 10 MINUTE)),
 UPPER(DAYNAME(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 10 MINUTE))), 1950000, 10),
(80, DATE(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 240 MINUTE)),
 UPPER(DAYNAME(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 240 MINUTE))), 2400000, 11),
(58, DATE(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 470 MINUTE)),
 UPPER(DAYNAME(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 470 MINUTE))), 1740000, 12),

-- 추가 스케줄 - 영화5~8, schedule_id 13~18
(95, DATE(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 800 MINUTE)),
 UPPER(DAYNAME(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 800 MINUTE))), 1425000, 13),
(110, DATE(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 1040 MINUTE)),
 UPPER(DAYNAME(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 1040 MINUTE))), 1650000, 14),
(70, DATE(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 800 MINUTE)),
 UPPER(DAYNAME(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 800 MINUTE))), 2100000, 15),
(85, DATE(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 1040 MINUTE)),
 UPPER(DAYNAME(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 1040 MINUTE))), 2550000, 16),
(100, DATE(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 800 MINUTE)),
 UPPER(DAYNAME(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 800 MINUTE))), 1500000, 17),
(75, DATE(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 1040 MINUTE)),
 UPPER(DAYNAME(DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 1040 MINUTE))), 2250000, 18);