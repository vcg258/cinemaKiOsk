...
//    @Operation(summary = "스케줄에서 예약된 좌석 조회")
    ...
    public ResponseEntity<List<String>> getUseSeatByScheduleId(@PathVariable("scheduleId") Long scheduleId){
...
//    @Operation(summary = "영화 아이디로 예약된 좌석 전체 조회")
    ...
    public ResponseEntity<List<ReservationDetailsDTO>> getUseSeatByMovieId(@PathVariable("movieId") Long movieId){
