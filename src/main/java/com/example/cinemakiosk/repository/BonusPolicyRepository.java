...
//    Page<BonusPolicyEntity> findKeyword(String keyword, Pageable pageable);
//
//    /*1. 쿼리 메서드 : 메서드의 이름 자체가 쿼리의 구문으로 처리되는 기능.*/
//    //https://docs.spring.io/spring-data/jpa/reference/jpa/query-methods.html
//
//    //게시판에서 "6"이 포함된 게시물을 검색. content like '%keyword%'
//    Page<BonusPolicyEntity> findByContentContaining(String keyword, Pageable pageable);
//
//
//    /*
...
//    Page<BonusPolicyEntity> findByContent(String keyword, Pageable pageable);
//
//
//    //@EntityGraph에는 attributePaths라는 속성을 이용해서 같이 로딩해야하는 속성을 명시할 수 있음.
//    @EntityGraph(attributePaths = {"imageSet"})
//    @Query("select b from Board b where b.bno = :bno")
//    Optional<BonusPolicyEntity> findByBnoWithImage(Long bno);
