...
import com.example.cinemakiosk.handler.MyWebSocketHanler;
...
public class WebSocketConfig implements WebSocketConfigurer {
    ...
    private final MyWebSocketHanler myWebSocketHandler;
    ...
    public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
        ...
        // 2. setAllowedOrigins("*"): 모든 도메인(키오스크 기기들)에서의 접속을 허용합니다. (CORS 방지)
                .setAllowedOrigins("*");
    }
}
