...
const editBtn   = { width: '100%', padding: '10px 0', background: 'var(--color-info-bg)', border: '1px solid var(--color-brand-default)',
                    borderRadius: 8, color: 'var(--color-brand-default)', fontSize: 13, fontWeight: 600, cursor: 'pointer' }
